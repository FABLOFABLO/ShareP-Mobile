        ...
        child: Scaffold(
          body: Column(
            ...
            children: [
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text('프롬프트, 태그, 계정 검색', style: AppTextStyles.body3.copyWith(color: AppColor.gray50, fontWeight: FontWeight.w700),)
                              ],
                            ),
                          ),
                        ),
              ...
              Text('검색하고 바로 복사', style: AppTextStyles.title1.copyWith(color: AppColor.gray100, fontWeight: FontWeight.w800),),
              const SizedBox(height: 10,),
              Text('계정·태그·제목으로 원하는 프롬프트를 찾고,\n복사 버튼으로 바로 활용해보세요!', style: AppTextStyles.body3.copyWith(color: AppColor.gray70), textAlign: TextAlign.center,),
              ...
              BottomButton(text: '다음', color: AppColor.primary, onTap: () => context.go('/onbording_4')),
