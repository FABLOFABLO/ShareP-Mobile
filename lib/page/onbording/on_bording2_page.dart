    ...
    return CustomScaffold(
      body: Column(
        children: [
                  ...
                  Container(
                    ...
                    child: Row(
                        children: [
                          ...
                          Text('최신순', style: AppTextStyles.body5.copyWith(color: AppColor.primary, fontWeight: FontWeight.w700),),
                          Icon(Icons.keyboard_arrow_down_rounded, color: AppColor.primary,)
                        ],
                      ),
                  ),
                  Spacer(),
                  Image.asset('assets/SVG - Sparkle Decor.png')
                ],
              ),
          ),
          Padding(
          ...
          Text('좋은 프롬프트를 한눈에', style: AppTextStyles.title1.copyWith(color: AppColor.gray100, fontWeight: FontWeight.w800),),
          const SizedBox(height: 10,),
          Text('최신순, 좋아요순으로 인기 프롬프트를\n둘러보고 마음에 드는 프롬프트를\n쉽게 발견해보세요!', style: AppTextStyles.body3.copyWith(color: AppColor.gray70), textAlign: TextAlign.center,),
          ...
          BottomButton(text: '다음', color: AppColor.primary, onTap: () => context.go('/onbording_3')),
