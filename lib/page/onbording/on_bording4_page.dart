        ...
        child: Scaffold(
          body: Column(
            ...
            children: [
              ...
              ProflieCard(name: '한지석', promptCount: 124, followerCount: 4, followingCount: 560),
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            ...
                            style: AppTextStyles.body1Bold.copyWith(color: AppColor.primary)
                          ),
                        ),
                        Expanded(
                          child: Text(
                            '좋아요한 프롬프트',
                            textAlign: TextAlign.center,
                            style: AppTextStyles.body3.copyWith(color: AppColor.gray50)
                          ),
                        ),
                      ],
                    ),
              ...
              const SizedBox(height: 30,),
              Text('공유하고 함께 성장해요', style: AppTextStyles.title1.copyWith(color: AppColor.gray100, fontWeight: FontWeight.w800),),
              const SizedBox(height: 10,),
              Text('나만의 프롬프트를 게시하고\n좋아요와 팔로우로 AI 결과물을\n함께 발전시켜보세요!', style: AppTextStyles.body3.copyWith(color: AppColor.gray70), textAlign: TextAlign.center,),
              Spacer(),
              Row(
              ...
              BottomButton(text: '다음', color: AppColor.primary, onTap: () => context.go('/login')),
