...
import 'package:share_prompt/features/prompt/view/widgets/prompt_tag.dart';
import 'package:share_prompt/core/constants/app_assets.dart';
      ...
      child: Platform.isAndroid
          ...
          : Container(
              ...
              child: Center(
                child: Row(
                  children: [
                    const Icon(Icons.check, size: 26, color: AppColor.white),
          ...
          Row(
            children: [
              ...
              GestureDetector(
                onTap: () {
                  showToast();
                  Clipboard.setData(const ClipboardData(text: promptContext));
                },
